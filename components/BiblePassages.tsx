...
export default function BiblePassages() {
  ...
  const passages: BiblePassage[] = [
    {
      ...
      explanation:
        "This is the foundation of God's love - He demonstrated the greatest love by sacrificing His Son for humanity.",
      application:
        "When we struggle to love others, remember God's ultimate sacrifice. This motivates us to love even difficult family members.",
      category: 'example',
    },
    {
      ...
      explanation:
        "Our ability to love comes from experiencing God's love first. We can't give what we haven't received.",
      application:
        "Before demanding love from your spouse or children, ensure you are showing them God's love through your actions and words.",
      category: 'promise',
    },
    {
      ...
      explanation:
        'This is the definitive description of love in action. These are the characteristics we should memorize and practice daily.',
      application:
        "Use this as your 'Yellow Card' - review these traits daily and ask: 'Did I show patience to my family today? Was I kind to my spouse?'",
      category: 'command',
    },
    {
      ...
      explanation:
        'Jesus summarizes all commandments into two: love God completely and love others as we love ourselves.',
      application:
        'In Nigerian families, this means loving your spouse and children as much as you love and care for yourself. No favoritism, no neglect.',
      category: 'command',
    },
    {
      ...
      application:
        'Nigerian husbands: your love should be demonstrated through daily sacrifice, protection, and service to your wife and family.',
      category: 'command',
    },
    {
      ...
      explanation:
        'You cannot claim to love God while hating or mistreating the people around you, especially family.',
      application:
        'Family conflicts in Nigeria often stem from unforgiveness. Practice forgiveness as the foundation of love.',
      category: 'warning',
    },
    {
      ...
      explanation:
        'Love should be genuine, not fake or hypocritical. Show preference and honor to family members.',
      application:
        "In Nigerian culture where respect is important, this means treating your spouse and children with the honor they deserve as God's creation.",
      category: 'command',
    },
    {
      ...
      application:
        'When family members make mistakes (as they will), let love cover it rather than keeping record of wrongs.',
      category: 'promise',
    },
  ];
  ...
  const getCategoryColor = (category: string) => {
    switch (category) {
      case 'command':
        return 'bg-orange-100 border-orange-300 text-red-800';
      case 'example':
        return 'bg-amber-100 border-amber-300 text-orange-800';
      case 'promise':
        return 'bg-orange-100 border-orange-300 text-red-800';
      case 'warning':
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Discover the biblical foundation of love and learn how to apply these timeless truths in
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center mb-2">
                        <span className="mr-2 text-gray-700">{getCategoryIcon(passage.category)}</span>
                        <h3 className="text-xl font-semibold text-gray-800">{passage.reference}</h3>
                      </div>
                      <span
                        className={`inline-block px-3 py-1 rounded-full text-sm font-medium border ${getCategoryColor(passage.category)}`}
                      >
        ...
        <div className="mt-16 text-center">
          <div className="bg-white rounded-xl p-8 shadow-lg max-w-4xl mx-auto">
            ...
            <p className="text-gray-600 mb-6">
              Choose one verse each day this week. Read it in the morning, meditate on it throughout
              the day, and ask yourself before bed: "How did I live out this truth in my family
              today?"
            </p>
