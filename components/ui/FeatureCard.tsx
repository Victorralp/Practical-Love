  ...
  "rounded-2xl p-6 md:p-8 shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-1 bg-white border",
  {
    variants: {
      accentColor: {
        ...
        green: "border-l-4 border-l-green-500 border-green-100 hover:border-green-200",
        blue: "border-l-4 border-l-blue-500 border-blue-100 hover:border-blue-200",
      },
    },
    defaultVariants: {
      accentColor: "red",
...
export interface FeatureCardProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof accentColorVariants> {
...
export function FeatureCard({
  ...
  return (
    <div
      className={cn(accentColorVariants({ accentColor }), className)}
      {...props}
    >
      <div className={iconBackgroundVariants({ accentColor })}>
        {icon}
      </div>
