  ...
  return (
    <div
      className={`bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 ${
        isCompleted ? 'ring-2 ring-amber-500 bg-amber-50' : 'hover:shadow-xl'
      }`}
    >
      {/* Header */}
        ...
        <div className="flex items-start justify-between">
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-2">
              <span
                className={`px-3 py-1 rounded-full text-sm font-medium border ${getCategoryColor(challenge.category)}`}
              >
          ...
          <div className="pt-4 space-y-4">
            ...
            {challenge.scriptureReference && (
              <div className="bg-orange-50 rounded-lg p-4 border border-orange-100">
                ...
                <p className="text-red-700 text-sm italic">{challenge.scriptureReference}</p>
              </div>
            )}
                ...
                {!showReflection ? (
                  <div className="flex gap-3">
                    <button
                      ...
                      className="flex-1 bg-amber-600 hover:bg-amber-700 text-white px-6 py-3 rounded-lg font-medium transition-colors flex items-center justify-center"
                    >
