  ...
  return (
    <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-xl p-8 text-center">
      ...
      <p className="text-gray-600 mb-6 max-w-md mx-auto">
        Every journey starts with a single step. Complete challenges, reflect on your growth, 
        and follow guided journeys to develop your capacity to love others.
      </p>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
        {milestones.map(milestone => (
          ...
          >
            ...
            <p className={`font-medium text-sm ${milestone.achieved ? 'text-green-800' : 'text-gray-600'}`}>
              {milestone.title}
            </p>
