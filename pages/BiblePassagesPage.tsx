...
export default function BiblePassagesPage() {
  ...
  const passages: BiblePassage[] = [
    ...
    },
    {
      ...
      explanation:
        'When operating in love, no human being can stop your blessing and promotion under the sun.',
    ...
    },
    {
      ...
      explanation:
        'The ultimate example of sacrificial love from God in heaven by giving the best of the best from heaven to those of us who do not deserve it.',
    ...
    },
    {
      ...
      explanation: 'The mark of a true disciple is love.',
    ...
    },
    {
      ...
      explanation: 'Obedience is thicker than blood.',
    ...
    },
    {
      ...
      explanation: 'Jesus is the only role model.',
    ...
    },
    {
      ...
      explanation:
        'Future glory for those who love God with present blessing and favour for those who operate in love.',
    ...
    },
    {
      ...
      explanation:
        "Sacrificial love in marriage does not depend on the wife's action — irrespective of their action.",
    ...
    },
    {
      ...
      explanation:
        "God's Spirit is not the spirit of fear — any spirit of fear is not a spirit of God.",
    ...
    },
    {
      ...
      explanation: 'Meaning and speaking the truth always.',
  ...
  return (
    <PageShell
      className="bg-gradient-to-b from-orange-100 to-red-50"
    ...
    >
      <PageHero
        ...
        title={
          <>
            Love Passages in <span className="text-orange-700">the New Testament</span>
          </>
        }
        subtitle={
          <>
            Explore 50 foundational passages about love that guide our ministry and daily life.
            <span className="block text-sm font-semibold text-orange-700 mt-2">
              Click any reference to read the verse.
            </span>
          </>
        }
      >
        <div className="bg-white border-l-8 border-amber-500 rounded-xl p-6 md:p-7 max-w-3xl shadow-sm">
          <p className="text-2xl font-serif font-bold text-gray-900 mb-2">
            "For God so loved the world"{' '}
            <span className="text-base text-gray-500 font-sans">(John 3:16)</span>
          </p>
          <p className="text-gray-700 font-medium text-lg">
            This includes every human being on this planet —{' '}
            <span className="text-red-700 font-bold uppercase">NO EXCEPTION!</span>
          </p>
        </div>
      </PageHero>
          ...
          <div className="mt-6 pt-6 border-t border-gray-100">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
              <div className="flex items-start gap-2 p-3 bg-orange-50 rounded-lg">
                <PenLine className="w-5 h-5 text-red-700 mt-0.5" />
                <div>
                  <p className="font-semibold text-red-800 text-sm">Command</p>
                  <p className="text-xs text-red-600">Instructions to follow</p>
                </div>
              </div>
              <div className="flex items-start gap-2 p-3 bg-orange-50 rounded-lg">
                <Lightbulb className="w-5 h-5 text-red-700 mt-0.5" />
                <div>
                  <p className="font-semibold text-red-800 text-sm">Example</p>
                  <p className="text-xs text-red-600">Love demonstrated</p>
                </div>
              </div>
              <div className="flex items-start gap-2 p-3 bg-amber-50 rounded-lg">
                <Sparkles className="w-5 h-5 text-orange-700 mt-0.5" />
                <div>
                  <p className="font-semibold text-orange-800 text-sm">Promise</p>
                  <p className="text-xs text-orange-600">God's assurances</p>
                </div>
              </div>
            ...
            <div className="mb-6 flex items-center justify-between">
              <p className="text-gray-600">
                ...
                <span className="font-semibold text-gray-800">
                  {passages.filter(p => p.category === activeFilter).length}
                </span>{' '}
                {categoryConfig[activeFilter]?.label.toLowerCase()} passages
              </p>
              <button
                type="button"
                onClick={() => setActiveFilter('all')}
              ...
              .map(passage => {
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      className={`absolute top-2 right-2 w-3 h-3 rounded-full ${config.color}`}
                      title={config.label}
                    ></div>
                    ...
                    {/* Category badge */}
                    <span
                      className={`inline-block mt-2 text-[10px] px-2 py-0.5 rounded-full ${config.bgLight} ${config.textColor} font-medium`}
                    >
              ...
              >
                ...
                <div
                  className={`p-4 border-b ${
                    passages[selectedPassage].category === 'command'
                      ? 'bg-orange-50 border-orange-200'
                      : passages[selectedPassage].category === 'promise'
                        ? 'bg-amber-50 border-amber-200'
                        : passages[selectedPassage].category === 'warning'
                ...
                >
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      >
                        {categoryConfig[passages[selectedPassage].category].icon}{' '}
                        {categoryConfig[passages[selectedPassage].category].label}
                      </span>
                    </div>
                    <button
                      type="button"
                ...
                >
                  ...
                  {passages[selectedPassage].application && (
                    <div className="bg-amber-50 p-3 rounded-xl border border-amber-200">
                      <h4 className="font-bold text-orange-800 mb-1 text-sm flex items-center">
        ...
        <div className="mt-20 flex flex-col items-center">
          <div className="bg-white rounded-2xl p-8 md:p-10 shadow-lg max-w-4xl w-full border-t-4 border-red-800">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              <div className="flex items-start">
                <span className="bg-red-100 text-red-800 font-bold rounded-full w-6 h-6 flex items-center justify-center mr-3 mt-1 text-sm">
                  1
                </span>
                <p>
                  Download the free books:{' '}
                  <span className="font-semibold text-gray-900">
                    Love Nigerian or Live on Curses
                  </span>{' '}
                  and{' '}
                  <span className="font-semibold text-gray-900">
                    Love Americans or Live on Curses
                  </span>{' '}
              ...
              <div className="flex items-start">
                ...
                <p>
                  Use a <span className="font-semibold">Life Application Bible Commentary</span> to
                  study these 50 passages in depth (passages 1-50).
                </p>
              </div>
              <div className="flex items-start">
                <span className="bg-red-100 text-red-800 font-bold rounded-full w-6 h-6 flex items-center justify-center mr-3 mt-1 text-sm">
                ...
                <p>
                  See the power of love in action by visiting our{' '}
                  <a
                    href="/testimonies"
                    className="text-red-600 font-bold hover:underline inline-block min-h-[44px] py-2"
                  >
                    Testimonies
                  </a>{' '}
                  page.
              ...
              <div className="flex items-start">
                ...
                <p className="font-semibold text-red-800">
                  Our Goal: Reproduce and give a Yellow Card to every NIGERIAN.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 bg-gradient-to-r from-red-600 to-orange-600 rounded-2xl p-10 max-w-4xl w-full text-center shadow-xl">
            ...
            <p className="text-xl text-orange-100 mb-8 max-w-2xl mx-auto">
              These 50 passages form the biblical foundation for understanding and practicing God's
              love.
            </p>
            <Link
              to="/publications"
              className="bg-white text-red-600 px-10 py-4 rounded-xl font-bold text-lg hover:bg-orange-50 transition-colors shadow-lg inline-flex items-center justify-center min-h-[44px]"
            >
              Browse Free Publications
            </Link>
          </div>
        </div>
    </PageShell>
