...
const passages: BiblePassage[] = [
  ...
  { reference: "Luke 6:32-35", text: "If you love those who love you, what credit is that to you? ... But love your enemies, do good to them, and lend to them without expecting to get anything back.", explanation: "Distinctive Christian love expects nothing in return.", application: "Give without expecting repayment.", category: "command" },
  { reference: "John 3:16", text: "For God so loved the world that he gave his one and only Son, that whoever believes in him shall not perish but have eternal life.", explanation: "The ultimate example of sacrificial love.", application: "Believe and receive God's love.", category: "example" },
  { reference: "John 13:34-35", text: "A new command I give you: Love one another. As I have loved you, so you must love one another. By this everyone will know that you are my disciples, if you love one another.", explanation: "The mark of a disciple is love.", application: "Love others as Jesus loved you.", category: "command" },
  { reference: "John 14:15", text: "If you love me, keep my commands.", explanation: "Love is demonstrated through obedience.", application: "Obey God's word as an act of love.", category: "command" },
  ...
  { reference: "John 15:9-19", text: "As the Father has loved me, so have I loved you. Now remain in my love... My command is this: Love each other as I have loved you.", explanation: "Abiding in God's love empowers us to love others.", application: "Spend time in God's presence.", category: "command" },
  ...
  { reference: "1 Corinthians 2:9", text: "However, as it is written: 'What no eye has seen, what no ear has heard, and what no human mind has conceived' — the things God has prepared for those who love him.", explanation: "Future glory for those who love God.", application: "Hope in God's future promises.", category: "promise" },
  ...
  { reference: "Ephesians 5:25", text: "Husbands, love your wives, just as Christ loved the church and gave himself up for her.", explanation: "Sacrificial love in marriage.", application: "Husbands, do something special for your wives.", category: "command" },
  ...
  { reference: "2 Timothy 1:7", text: "For the Spirit God gave us does not make us timid, but gives us power, love and self-discipline.", explanation: "God's Spirit empowers love.", application: "Rely on the Spirit's power to love.", category: "promise" },
  ...
  { reference: "1 Peter 3:10", text: "For, 'Whoever would love life and see good days must keep their tongue from evil and their lips from deceitful speech.'", explanation: "Loving life requires controlling speech.", application: "Speak only good today.", category: "command" },
