  ...
  const strategySteps = [
    {
      ...
      description:
        'Distribute the 17 Characteristics of Love to every believer as a daily reminder and guide.',
    },
    {
      number: 2,
      title: 'Teach the Characteristics',
      description:
        'Help families memorize and understand each characteristic through practical teaching.',
    },
    {
      number: 3,
      ...
      />
        ...
        <div className="bg-white rounded-2xl p-8 md:p-12 shadow-xl border border-orange-100 mb-12 text-center">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto leading-relaxed mb-6">
            We believe that when families learn and practice the 17 Characteristics of Love from 1
            Corinthians 13, transformation is inevitable — in homes, communities, and the entire
            nation.
          </p>
          <div className="bg-orange-50 border-l-4 border-orange-500 rounded-r-xl p-6 text-left max-w-3xl mx-auto">
            <p className="text-gray-700 leading-relaxed mb-3">
              <span className="font-semibold text-red-700">This Love Ministry</span>, using the Love
              Card, aims to remain in the heart of every Nigerian — the heart of flesh — so that God
              can write His commandments in our hearts, starting with every family.
            </p>
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          <div className="bg-white rounded-2xl p-8 shadow-lg border-t-4 border-yellow-500">
            ...
            <p className="text-gray-700 mb-6 leading-relaxed">
              To see every Nigerian family transformed by the power of God's love — breaking the
              cycle of corruption, wickedness, and materialism through the root of all change:
        ...
        <div className="bg-white rounded-2xl p-8 md:p-12 shadow-xl border border-orange-100 text-center">
          ...
          <p className="text-gray-600 text-lg mb-8 max-w-2xl mx-auto leading-relaxed">
            Be part of the transformation. Start practicing love today and help us change Nigeria
            one heart at a time.
          </p>
