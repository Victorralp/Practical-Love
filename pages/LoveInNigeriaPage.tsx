...
export default function LoveInNigeriaPage() {
  const loveMessages = [
    ...
    { content: "God's Love language is in the yellow card in your hand.", isHighlight: false },
    { content: "Any family who is able to memorize and practicalized the characteristics of Love in his or her family IT IS MANDATORY OR COMPULSORY FOR GOD TO BLESS THAT FAMILY.", isHighlight: false },
    { content: "If you love your wife and/or wife Love your husband, parents Love their children and children Love your parents based on THIS LANGUAGE OF LOVE IN THE YELLOW CARD IN YOUR HAND, you are honouring God and God says those who honour me I will honour them.", isHighlight: false },
    { content: "Any Nigerian deep or stubborn in corruption and wickedness, trace their roots, they usually don't come from a LOVING AND GODLY/GOD FEARING AND LOVING HOMES/FAMILIES.", isHighlight: false },
    { content: "There is no way something good will come out of Loving and Godly family, that will not impact the family, community, church, mosque and society at large, E.g. Mrs. Ngozi Okonjo-Iweala and Mr. Adesina Akinwunmi of (AFDB).", isHighlight: false }
  ]
